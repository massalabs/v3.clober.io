...
const UserTransactionCard = ({ transaction }: { transaction: Transaction }) => {
  return (
    <div className="flex items-center justify-center bg-black bg-opacity-50 z-[1000] backdrop-blur-sm px-4 sm:px-0">
      <div
        className="flex flex-col w-full min-w-[320px] bg-gray-800 text-white rounded-xl sm:rounded-2xl p-4 gap-3"
        ...
        <div className="flex flex-col gap-1.5">
          {transaction.fields.map((field, index) => (
            <div key={index} className="flex flex-row gap-1">
              ...
              <div className="flex w-full items-center justify-between bg-gray-700 px-3 py-1.5 text-xs sm:text-sm rounded-lg">
